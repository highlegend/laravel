...
@endpush
@section('content')
    <form method="post" id="article_save" action="{{route('articles.store')}}" >
@csrf
        <div class="col-md-9 col-lg-12">
            <h4 class="mb-3">Nouvel Article</h4>
            <div class="col-md-8">
                <label for="title" class="form-label">Titre</label>
                <input id="title" type="text" class="form-control" name="title" placeholder="Titre" required>
            </div>
            <div class="col-md-12">
                <label for="content_fr" class="form-label">Contenu en français</label>
                <textarea  name="content_fr" id="content_fr" required></textarea>
            </div>
